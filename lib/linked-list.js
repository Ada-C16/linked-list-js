...
class LinkedList {
    ...
    */
    reverse() {
        // create a newHead set to null -- represents previous items in head, i.e. a reversal
        // create pointer for nextNode that will be head in next iteration
        // loop while head is non-empty
        // at the end set head to newHead
        let head = this.#head;
        let nextNode;
        let newHead = null;
    ...
    findMiddleValue() {
        ...
        // Get length
        // Get middle value and store in var floor value using Math
