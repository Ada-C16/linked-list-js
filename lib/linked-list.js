...
class LinkedList {
    ...
    */
    reverse() {
        ...
        // Use addFirst on each item to add to other list
        let newList = new LinkedList();
        let current = this.#head;
        while (current) {
            newList.addFirst(current); // adds new node to beginning of new List
            current = current.next;
        }
        
        this = newList; // Update this instance to newList instance
    }
